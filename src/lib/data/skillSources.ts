...
export const SKILL_SOURCES: SkillSourceEntry[] = [
  {
    ...
    description: 'Anthropic 官方技能库:docx/pdf/pptx/xlsx 文档处理、skill-creator 等生产级技能',
    tags: ['官方'],
  },
  {
    id: 'superpowers',
    ...
    description: '知名社区技能框架:TDD、调试、协作等 20+ 软件开发方法论技能,多 agent 兼容',
    tags: ['社区'],
  },
];
